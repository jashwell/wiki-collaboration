  ...
  describe "POST #create" do
    context "with valid attributes" do
      it "saves the new wiki in the database" do
        expect {
          post :create, wiki: FactoryGirl.attributes_for(:wiki)
    ...
    context "with invalid attributes" do
      it "does not save the new wiki in the database" do
        expect{
          post :create, wiki: FactoryGirl.attributes_for(:invalid_contact)
  ...
  describe 'PUT update' do
    ...
    context "valid attributes" do
      it "located the requested wiki" do
        put :update, id: @wiki, wiki: FactoryGirl.attributes_for(:wiki)
        expect(assigns(:wiki)).to eq([wiki])
      end

      it "changes wiki's attributes" do
        put :update, id: @wiki,
          wiki: FactoryGirl.attributes_for(:wiki, title: "RSpec Title", body: "RSpec Body Text" )
          @wiki.reload
    ...
    context "invalid attributes" do
      it "locates the requested wiki" do
        put :update, id: @wiki, wiki: FactoryGirl.attributes_for(:invalid_wiki)
        expect(assigns(:wiki)).to eq([wiki])
      end

      it "does not change wiki's attributes" do
        put :update, id: @wiki,
          wiki: FactoryGirl.attributes_for(:wiki, titel: "nil", body: "RSpec Body Text")
          @wiki.reload
